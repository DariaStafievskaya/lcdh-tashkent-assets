      ...
      <div class="news__grid">${Qc().map(t=>`
        <button type="button" class="news-card" data-news-id="${t.id}">
          ...
          <div class="news-card__body">
            <div class="news-card__date">${Po(t.date)}</div>
...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:pn,depthTest:!1,depthWrite:!1})}function vh(i,e,t){const n=new Float32Array(On),a=new k(0,1,0);return new an({name:"SphericalGaussianBlur",defines:{n:On,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/t,CUBEUV_MAX_MIP:`${i}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:n},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:a}},vertexShader:xa(),fragmentShader:`
		...
		`,blending:pn,depthTest:!1,depthWrite:!1})}function ro(){return new an({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:xa(),fragmentShader:`
		...
		`,blending:pn,depthTest:!1,depthWrite:!1})}function so(){return new an({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:xa(),fragmentShader:`
	...
	`}class dc extends Qt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;const n={width:e,height:e,depth:1},a=[n,n,n,n,n,n];this.texture=new ic(a),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;const n={uniforms:{tEquirect:{value:null}},vertexShader:`
			...
			`},a=new Li(5,5,5),r=new an({name:"CubemapFromEquirect",uniforms:hi(n.uniforms),vertexShader:n.vertexShader,fragmentShader:n.fragmentShader,side:Rt,blending:pn});r.uniforms.tEquirect.value=t;const s=new nn(a,r),o=t.minFilter;return t.minFilter===kn&&(t.minFilter=yt),new Ad(1,10,this).update(e,s),t.minFilter=o,s.geometry.dispose(),s.material.dispose(),this}clear(e,t=!0,n=!0,a=!0){const r=e.getRenderTarget();for(let s=0;s<6;s++)e.setRenderTarget(this,s),e.clear(t,n,a);e.setRenderTarget(r)}}function yh(i){let e=new WeakMap,t=new WeakMap,n=null;function a(d,m=!1){return d==null?null:m?s(d):r(d)}function r(d){if(d&&d.isTexture){const m=d.mapping;if(m===Ta||m===Aa)if(e.has(d)){const b=e.get(d).texture;return o(b,d.mapping)}else{const b=d.image;if(b&&b.height>0){const v=new dc(b.height);return v.fromEquirectangularTexture(i,d),e.set(d,v),d.addEventListener("dispose",c),o(v.texture,d.mapping)}else return null}}return d}function s(d){if(d&&d.isTexture){const m=d.mapping,b=m===Ta||m===Aa,v=m===zn||m===ui;if(b||v){let g=t.get(d);const u=g!==void 0?g.texture.pmremVersion:0;if(d.isRenderTargetTexture&&d.pmremVersion!==u)return n===null&&(n=new io(i)),g=b?n.fromEquirectangular(d,g):n.fromCubemap(d,g),g.texture.pmremVersion=d.pmremVersion,t.set(d,g),g.texture;if(g!==void 0)return g.texture;{const E=d.image;return b&&E&&E.height>0||v&&E&&l(E)?(n===null&&(n=new io(i)),g=b?n.fromEquirectangular(d):n.fromCubemap(d),g.texture.pmremVersion=d.pmremVersion,t.set(d,g),d.addEventListener("dispose",f),g.texture):null}}}return d}function o(d,m){return m===Ta?d.mapping=zn:m===Aa&&(d.mapping=ui),d}function l(d){let m=0;const b=6;for(let v=0;v<b;v++)d[v]!==void 0&&m++;return m===b}function c(d){const m=d.target;m.removeEventListener("dispose",c);const b=e.get(m);b!==void 0&&(e.delete(m),b.dispose())}function f(d){const m=d.target;m.removeEventListener("dispose",f);const b=t.get(m);b!==void 0&&(t.delete(m),b.dispose())}function h(){e=new WeakMap,t=new WeakMap,n!==null&&(n.dispose(),n=null)}return{get:a,dispose:h}}function Mh(i){const e={};function t(n){if(e[n]!==void 0)return e[n];const a=i.getExtension(n);return e[n]=a,a}return{has:function(n){return t(n)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(n){const a=t(n);return a===null&&ci("WebGLRenderer: "+n+" extension not supported."),a}}}function Eh(i,e,t,n){const a={},r=new WeakMap;function s(h){const d=h.target;d.index!==null&&e.remove(d.index);for(const b in d.attributes)e.remove(d.attributes[b]);d.removeEventListener("dispose",s),delete a[d.id];const m=r.get(d);m&&(e.remove(m),r.delete(d)),n.releaseStatesOfGeometry(d),d.isInstancedBufferGeometry===!0&&delete d._maxInstanceCount,t.memory.geometries--}function o(h,d){return a[d.id]===!0||(d.addEventListener("dispose",s),a[d.id]=!0,t.memory.geometries++),d}function l(h){const d=h.attributes;for(const m in d)e.update(d[m],i.ARRAY_BUFFER)}function c(h){const d=[],m=h.index,b=h.attributes.position;let v=0;if(b===void 0)return;if(m!==null){const E=m.array;v=m.version;for(let R=0,S=E.length;R<S;R+=3){const A=E[R+0],y=E[R+1],C=E[R+2];d.push(A,y,y,C,C,A)}}else{const E=b.array;v=b.version;for(let R=0,S=E.length/3-1;R<S;R+=3){const A=R+0,y=R+1,C=R+2;d.push(A,y,y,C,C,A)}}const g=new(b.count>=65535?tc:ec)(d,1);g.version=v;const u=r.get(h);u&&e.remove(u),r.set(h,g)}function f(h){const d=r.get(h);if(d){const m=h.index;m!==null&&d.version<m.version&&c(h)}else c(h);return r.get(h)}return{get:o,update:l,getWireframeAttribute:f}}function Th(i,e,t){let n;function a(h){n=h}let r,s;function o(h){r=h.type,s=h.bytesPerElement}function l(h,d){i.drawElements(n,d,r,h*s),t.update(d,n,1)}function c(h,d,m){m!==0&&(i.drawElementsInstanced(n,d,r,h*s,m),t.update(d,n,m))}function f(h,d,m){if(m===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(n,d,0,r,h,0,m);let v=0;for(let g=0;g<m;g++)v+=d[g];t.update(v,n,1)}this.setMode=a,this.setIndex=o,this.render=l,this.renderInstances=c,this.renderMultiDraw=f}function Ah(i){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function n(r,s,o){switch(t.calls++,s){case i.TRIANGLES:t.triangles+=o*(r/3);break;case i.LINES:t.lines+=o*(r/2);break;case i.LINE_STRIP:t.lines+=o*(r-1);break;case i.LINE_LOOP:t.lines+=o*r;break;case i.POINTS:t.points+=o*r;break;default:He("WebGLInfo: Unknown draw mode:",s);break}}function a(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:a,update:n}}function Rh(i,e,t){const n=new WeakMap,a=new at;function r(s,o,l){const c=s.morphTargetInfluences,f=o.morphAttributes.position||o.morphAttributes.normal||o.morphAttributes.color,h=f!==void 0?f.length:0;let d=n.get(o);if(d===void 0||d.count!==h){let T=function(){C.dispose(),n.delete(o),o.removeEventListener("dispose",T)};d!==void 0&&d.texture.dispose();const m=o.morphAttributes.position!==void 0,b=o.morphAttributes.normal!==void 0,v=o.morphAttributes.color!==void 0,g=o.morphAttributes.position||[],u=o.morphAttributes.normal||[],E=o.morphAttributes.color||[];let R=0;m===!0&&(R=1),b===!0&&(R=2),v===!0&&(R=3);let S=o.attributes.position.count*R,A=1;S>e.maxTextureSize&&(A=Math.ceil(S/e.maxTextureSize),S=e.maxTextureSize);const y=new Float32Array(S*A*4*h),C=new $o(y,S,A,h);C.type=Yt,C.needsUpdate=!0;const _=R*4;for(let P=0;P<h;P++){const L=g[P],D=u[P],X=E[P],q=S*A*4*P;for(let O=0;O<L.count;O++){const Z=O*_;m===!0&&(a.fromBufferAttribute(L,O),y[q+Z+0]=a.x,y[q+Z+1]=a.y,y[q+Z+2]=a.z,y[q+Z+3]=0),b===!0&&(a.fromBufferAttribute(D,O),y[q+Z+4]=a.x,y[q+Z+5]=a.y,y[q+Z+6]=a.z,y[q+Z+7]=0),v===!0&&(a.fromBufferAttribute(X,O),y[q+Z+8]=a.x,y[q+Z+9]=a.y,y[q+Z+10]=a.z,y[q+Z+11]=X.itemSize===4?a.w:1)}}d={count:h,texture:C,size:new We(S,A)},n.set(o,d),o.addEventListener("dispose",T)}if(s.isInstancedMesh===!0&&s.morphTexture!==null)l.getUniforms().setValue(i,"morphTexture",s.morphTexture,t);else{let m=0;for(let v=0;v<c.length;v++)m+=c[v];const b=o.morphTargetsRelative?1:1-m;l.getUniforms().setValue(i,"morphTargetBaseInfluence",b),l.getUniforms().setValue(i,"morphTargetInfluences",c)}l.getUniforms().setValue(i,"morphTargetsTexture",d.texture,t),l.getUniforms().setValue(i,"morphTargetsTextureSize",d.size)}return{update:r}}function Ch(i,e,t,n,a){let r=new WeakMap;function s(c){const f=a.render.frame,h=c.geometry,d=e.get(c,h);if(r.get(d)!==f&&(e.update(d),r.set(d,f)),c.isInstancedMesh&&(c.hasEventListener("dispose",l)===!1&&c.addEventListener("dispose",l),r.get(c)!==f&&(t.update(c.instanceMatrix,i.ARRAY_BUFFER),c.instanceColor!==null&&t.update(c.instanceColor,i.ARRAY_BUFFER),r.set(c,f))),c.isSkinnedMesh){const m=c.skeleton;r.get(m)!==f&&(m.update(),r.set(m,f))}return d}function o(){r=new WeakMap}function l(c){const f=c.target;f.removeEventListener("dispose",l),n.releaseStatesOfObject(f),t.remove(f.instanceMatrix),f.instanceColor!==null&&t.remove(f.instanceColor)}return{update:s,dispose:o}}const wh={[Do]:"LINEAR_TONE_MAPPING",[Bo]:"REINHARD_TONE_MAPPING",[Fo]:"CINEON_TONE_MAPPING",[Oo]:"ACES_FILMIC_TONE_MAPPING",[Ho]:"AGX_TONE_MAPPING",[zo]:"NEUTRAL_TONE_MAPPING",[ko]:"CUSTOM_TONE_MAPPING"};function Lh(i,e,t,n,a,r){const s=new Qt(e,t,{type:i,depthBuffer:a,stencilBuffer:r,samples:n?4:0,depthTexture:a?new fi(e,t):void 0}),o=new Qt(e,t,{type:gn,depthBuffer:!1,stencilBuffer:!1}),l=new rn;l.setAttribute("position",new Ft([-1,3,0,-1,-1,0,3,-1,0],3)),l.setAttribute("uv",new Ft([0,2,0,0,2,0],2));const c=new Md({uniforms:{tDiffuse:{value:null}},vertexShader:`
			precision highp float;
...
`)}const Ap={[Do]:"Linear",[Bo]:"Reinhard",[Fo]:"Cineon",[Oo]:"ACESFilmic",[Ho]:"AgX",[zo]:"Neutral",[ko]:"Custom"};function Rp(i,e){const t=Ap[e];return t===void 0?(Re("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+i+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+i+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const ta=new k;function Cp(){Be.getLuminanceCoefficients(ta);const i=ta.x.toFixed(4),e=ta.y.toFixed(4),t=ta.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
...
void main() {
  ...
  ${al()}
  ${rl()}
`;const cg=sl();Bc(cg.open);kc();Cc(async()=>{const{initSphere:i}=await Promise.resolve().then(()=>ig);return{initSphere:i}},void 0,import.meta.url).then(({initSphere:i})=>i(document.getElementById("about-sphere")));Zc();nl();ll(document);sg();
